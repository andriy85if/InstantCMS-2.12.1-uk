...
CREATE TABLE `{#}comments` (
  ...
  `date_last_modified` timestamp NULL DEFAULT NULL COMMENT 'Дата зміни',
...
(10, 'Видаляє застарілі сесії', 'users', 'sessionclean', 10, NULL, NULL, 1, 1);
...
CREATE TABLE `{#}users` (
  ...
  `password` varchar(32) DEFAULT NULL COMMENT 'Хеш пароля (застаріле поле)',
  `password_salt` varchar(16) DEFAULT NULL COMMENT 'Соль пароля (застаріле поле)',
...
CREATE TABLE `{#}wall_entries` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `date_pub` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Дата публікації',
  `date_last_reply` timestamp NULL DEFAULT NULL COMMENT 'Дата останньої відповіді',
  `date_last_modified` timestamp NULL DEFAULT NULL COMMENT 'Дата зміни',
...
CREATE TABLE `{#}widgets_bind` (
  ...
  `is_tab_prev` tinyint(1) UNSIGNED DEFAULT NULL COMMENT 'Обʼєднувати з попереднім?',
  `groups_view` text COMMENT 'Показувати групам',
...
(1, NULL, NULL, 3, 'Головне меню', NULL, NULL, NULL, NULL, NULL, NULL, '---\n- 0\n', NULL, '---\nmenu: main\nis_detect: 1\nmax_items: 8\n', NULL, NULL, NULL),
(2, NULL, NULL, 3, 'Меню авторизації', NULL, NULL, NULL, NULL, NULL, NULL, '---\n- 1\n', NULL, '---\nmenu: header\nis_detect: 1\nmax_items: 0\n', NULL, NULL, NULL),
(5, NULL, NULL, 3, 'Меню дій', NULL, NULL, NULL, 'fixed_actions_menu', NULL, NULL, '---\n- 0\n', NULL, '---\nmenu: toolbar\ntemplate: menu\nis_detect: null\nmax_items: 0\n', 'menu', 'wrapper', NULL),
(20, NULL, NULL, 12, 'Увійти на сайт', NULL, NULL, NULL, NULL, 1, NULL, '---\n- 0\n', NULL, '', NULL, NULL, NULL),
(22, NULL, NULL, 9, 'Меню користувача', NULL, NULL, NULL, NULL, NULL, NULL, '---\n- 0\n', '---\n- 1\n', '---\nmenu: personal\nis_detect: 1\nmax_items: 0\n', 'avatar', 'wrapper', NULL),
(23, NULL, NULL, 3, 'Сповіщення', NULL, NULL, NULL, NULL, NULL, NULL, '---\n- 0\n', '---\n- 1\n', '---\nmenu: notices\ntemplate: menu\nis_detect: null\nmax_items: 0\n', 'menu', 'wrapper', NULL);
